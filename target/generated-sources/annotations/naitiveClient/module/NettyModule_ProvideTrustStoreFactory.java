...
public final class NettyModule_ProvideTrustStoreFactory implements Factory<CertDetails> {
  private final NettyModule module;

  private final Provider<ContextSupplier<Args>> contextSupplierProvider;

  public NettyModule_ProvideTrustStoreFactory(
  ...
  public CertDetails get() {
    return Preconditions.checkNotNull(
        module.provideTrustStore(contextSupplierProvider.get()),
        "Cannot return null from a non-@Nullable @Provides method");
  }

  public static Factory<CertDetails> create(
      NettyModule module, Provider<ContextSupplier<Args>> contextSupplierProvider) {
    return new NettyModule_ProvideTrustStoreFactory(module, contextSupplierProvider);
  }
}
